...
namespace Solutions.Solutions
{
    ...
    /// </summary>
    public static class Problem_0008
    {
        ...
        public static ulong Solve()
        {
            ...
            {
                var numberToDecompose = number.Substring(i, 13);
        ...
        /// <summary>
        /// Decompose a string that represent an integer in factors
        /// ex: "4826" => { 4, 8, 2, 6}
        /// </summary>
        /// <param name="number">String number to decompose</param>
        /// <returns>The factor list</returns>
        private static List<ulong> GetFactors(string number)
        {
